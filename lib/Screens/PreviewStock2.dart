...
class MyStockPreview extends StatefulWidget {
  const MyStockPreview({super.key});

  @override
  State<MyStockPreview> createState() => _MyStockPreviewState();
}

class _MyStockPreviewState extends State<MyStockPreview> {
  @override
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Center(
                  child: Text(
                "Your order has been and will be\nexcuted as soon as ,arket opens",
                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        child: Image.asset("assets/images/Staff+Photos.png"),
                      ),
                      const SizedBox(
                        width: 15,
                      ),
