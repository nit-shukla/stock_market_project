...
class MyDepositSecond extends StatefulWidget {
  const MyDepositSecond({super.key});

  @override
  State<MyDepositSecond> createState() => _MyDepositSecondState();
}

class _MyDepositSecondState extends State<MyDepositSecond> {
  @override
                      ...
                      InkWell(
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => MyPaymentSummary(),
                              ));
                        },
                        child: Container(
                          decoration: BoxDecoration(
